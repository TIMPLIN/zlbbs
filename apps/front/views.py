from flask import Blueprint, views, render_template, request, url_for, session, g, abort, redirect
...
def index():
    ...
    banners = BannerModel.query.limit(4)
    ...
    elif sort == 3:   #按照点赞数进行排序
        query_obj = PostModel.query.order_by(PostModel.create_time.desc())
    elif sort == 4:   #按照评论数进行排序
